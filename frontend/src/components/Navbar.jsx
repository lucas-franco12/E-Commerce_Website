        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          {userType === 'customer' ?
            <div className="navbar-nav ms-auto">
              ...
              <Link className="nav-link" to={`/orders?userId=${userId}&userType=${userType}`}>View Orders</Link>
              <Link className="nav-link" to={`/account/${userId}?userType=${userType}`}>Manage Account</Link>          
            </div> 
            : 
            <div className="navbar-nav ms-auto">
