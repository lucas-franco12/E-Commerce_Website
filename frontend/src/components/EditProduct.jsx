...
//           <div className="btn cart--delete" onClick={handleDeleteProduct()}>Yes, delete product.</div>
...
//                 </div>
//               </div>
//               <input id="submit-button" type="submit" className="btn form--btn submit" value="Update Product" />
//               <div className="btn cart--delete" value="Delete Product" onClick={setDeleteProduct(true)}></div>
